...
if __name__ == "__main__":
    ...
    parser.add_argument('--use_cam_ids', action='store_true',
                        help='use the cam_ids to get the images')
    ...
    if args.viperx:
        ...
        cam_ids = args.cam_ids if args.use_cam_ids else None
        ...
        # TODO: support multiple cam_ids
        interface = WidowXRos2Interface(cam_id=args.cam_ids[0], blocking_control=_blocking)
    else:
